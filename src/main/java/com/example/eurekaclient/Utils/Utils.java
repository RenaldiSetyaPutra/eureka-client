...
public class Utils {
    ...
    static void randomString(){
        ...
        for (int i = 1; i<6; i++){
            int random_int = (random.nextInt(20) + 1) * 5;
    ...
    static void formatString(){
        ...
        int lastNumberOrder = 001;
        lastNumberOrder++;
        String nextNumberOrder = String.format("%03d", lastNumberOrder);
        String randomString = "ABC"
                .concat(date.format(formatter))
                .concat("-")
                .concat(nextNumberOrder);
